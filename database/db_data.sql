...
-- Started on 2022-01-31 17:22:43
...
--
-- TOC entry 226 (class 1255 OID 49366)
-- Name: add_film(text, integer, text, text[], text, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.add_film(title text, release integer, subordinate text, genre text[], distributor text, overview text, username text) RETURNS boolean
    LANGUAGE plpgsql
    AS $_$
...
IF (SELECT EXISTS(SELECT 1 FROM public.film_storage WHERE film_title = title)) THEN
	RETURN FALSE;
ELSE	
	INSERT INTO public.film_storage (film_title, film_release, film_subordinate, film_genre, film_distributor, film_overview, username)
...
ALTER FUNCTION public.add_film(title text, release integer, subordinate text, genre text[], distributor text, overview text, username text) OWNER TO postgres;

--
-- TOC entry 227 (class 1255 OID 49368)
...
--
-- TOC entry 231 (class 1255 OID 49374)
-- Name: edit_film(integer, text, integer, text[], text, text, integer, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.edit_film(id integer, title text, release integer, genre text[], distributor text, overview text, rating integer, username text) RETURNS boolean
    LANGUAGE plpgsql
    AS $_$
...
ALTER FUNCTION public.edit_film(id integer, title text, release integer, genre text[], distributor text, overview text, rating integer, username text) OWNER TO postgres;

--
-- TOC entry 229 (class 1255 OID 49373)
...
IF subordinate IS NULL THEN
	DELETE FROM public.film_storage 
 	WHERE film_title = $1;
ELSE
	DELETE FROM public.film_storage 
	WHERE film_subordinate = $2;
END IF;
...
--
-- TOC entry 228 (class 1255 OID 49372)
...
--
-- TOC entry 213 (class 1255 OID 49311)
...
--
-- TOC entry 214 (class 1255 OID 49328)
...
--
-- TOC entry 212 (class 1259 OID 49354)
...
--
-- TOC entry 211 (class 1259 OID 49353)
...
--
-- TOC entry 210 (class 1259 OID 49345)
...
--
-- TOC entry 209 (class 1259 OID 49344)
...
--
-- TOC entry 3179 (class 2604 OID 49357)
...
--
-- TOC entry 3178 (class 2604 OID 49348)
...
--
-- TOC entry 3326 (class 0 OID 49354)
-- Dependencies: 212
...
INSERT INTO public.film_storage (film_id, film_title, film_release, film_subordinate, film_genre, film_director, film_writer, film_producer, film_actor, film_distributor, film_overview, film_rating, username) VALUES (8, 'Dark Shadows', 2012, NULL, '{Fantasy,Comedy,Horror}', 'Tim Burton', 'John August', 'Richard D. Zanuck', 'Johnny Depp', 'Warner Bros. Pictures', 'Rich playboy Barnabas earns the wrath of Angelique, a witch, when he breaks her heart. She turns him into a vampire and buries him alive. Two centuries later, Barnabas escapes to settle old scores.', 5, 'admin2');
INSERT INTO public.film_storage (film_id, film_title, film_release, film_subordinate, film_genre, film_director, film_writer, film_producer, film_actor, film_distributor, film_overview, film_rating, username) VALUES (44, 'Test Film5', 2022, 'test', '{Romance,Action}', '41', '41', 'Test Person6', 'Test Person6', 'Monkol Film', 'This is Test movie for create SP function.', NULL, 'admin1');
INSERT INTO public.film_storage (film_id, film_title, film_release, film_subordinate, film_genre, film_director, film_writer, film_producer, film_actor, film_distributor, film_overview, film_rating, username) VALUES (39, 'Test Film', 2022, 'test', '{Romance,Action}', NULL, NULL, NULL, NULL, 'Monkol Film', 'This is Test movie for create SP function.', NULL, 'admin1');
INSERT INTO public.film_storage (film_id, film_title, film_release, film_subordinate, film_genre, film_director, film_writer, film_producer, film_actor, film_distributor, film_overview, film_rating, username) VALUES (41, 'Test Film2', 2026, 'test', '{Sci-fi,Action}', NULL, NULL, NULL, NULL, 'Warner Bros. Pictures', 'Test film overview data.', NULL, NULL);
...
SELECT pg_catalog.setval('public.film_person_person_id_seq', 45, true);
...
SELECT pg_catalog.setval('public.film_storage_film_id_seq', 44, true);


--
-- TOC entry 3183 (class 2606 OID 49361)
...
--
-- TOC entry 3181 (class 2606 OID 49352)
...
-- Completed on 2022-01-31 17:22:43
